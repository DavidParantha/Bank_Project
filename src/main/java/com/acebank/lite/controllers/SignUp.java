    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (resultOpt.isPresent()) {
                ...
                request.setAttribute("errorTitle", "Account Creation Failed");
                request.setAttribute("errorMessage",
                        "We could not create your account. Please check your details or try again later.");
            ...
            request.setAttribute("errorMessage",
                    "We encountered an unexpected error while trying to process your application. Please try again later.");
